...
class HomeController extends Controller
{
    ...
    public function naruci()
    {
        ...
        return redirect('/')->with('message', 'Uspješno poslana narudžba!');
    }
    ...
    public function filter_produkti($filter)
    {
        $kategorija=Kategorija::all();
        $artikal=Artikli::where('kategorija', '=', $filter)->paginate(6);
        $pretraga='';
        return view('home.allprodukti',['pretraga' => $pretraga] ,compact('artikal', 'kategorija'));
    }
