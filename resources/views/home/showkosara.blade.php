                  ...
                  <table class="table table-bordered m-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center align-middle px-0"><a href="{{url('obrisi_kosara', $cart->id)}}" onclick="return confirm('Da li želite obrisati ovaj artikal iz košarice?')" class="shop-tooltip close float-none text-danger" title="" data-original-title="Remove">×</a></td>
                      </tr>
                      <?php
