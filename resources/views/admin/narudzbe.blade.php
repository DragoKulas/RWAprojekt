            ...
            <table class="table_deg">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('odobreno', $order->id)}}" onclick="return confirm('Da li želite odobriti ovaj zahtjev i poslati artikal u dostavu?')" class="btn btn-primary mb-2">Odobri</a>
                        <a href="{{url('odbijeno', $order->id)}}" onclick="return confirm('Da li želite poništiti ovaj zahtjev?')"class="btn btn-danger">Odbij</a>
                        @else
                        <p>Narudzba završena</p>
                        @endif
                    </td>
